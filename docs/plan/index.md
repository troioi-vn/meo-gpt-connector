...
| --- | ------ | ------------------------------------------------ | --------------------------------------------------------------------------- |
| 01  | todo   | [01-setup-project.md](./01-setup-project.md)     | Init FastAPI, Docker, configuration, logging, health check, basic CI tests  |
| 02  | todo   | [02-auth-utils.md](./02-auth-utils.md)           | Redis client setup, JWT utilities, Sanctum token AES encryption             |
...
**Current Focus:** [01-setup-project.md](./01-setup-project.md)
