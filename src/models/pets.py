...
class CreatePetRequest(BaseModel):
    ...
    country: str = Field(min_length=2, max_length=2, description="2-letter ISO 3166-1 alpha-2 country code where the pet lives (e.g. 'VN', 'US', 'DE'). Ask the user if not known from context.")
